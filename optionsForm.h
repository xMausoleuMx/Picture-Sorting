...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->checkBoxUpdateContinuously->Location = System::Drawing::Point(132, 3);
			...
			this->label1->Size = System::Drawing::Size(121, 26);
			...
			this->toolTip1->SetToolTip(this->label4, L"Sorts top and bottom list by rating. Usefull for large image collections where it"
				L" is unreasonable to compare all images");
			// 
			// checkBoxScoreSort
			// 
			...
			this->checkBoxScoreSort->Location = System::Drawing::Point(132, 67);
			...
			this->checkBoxRatingSort->Location = System::Drawing::Point(132, 93);
			...
			this->toolTip1->SetToolTip(this->checkBoxRatingSort, L"Sorts top and bottom list by rating. Usefull for large image collections where it"
				L" is unreasonable to compare all images");
			...
			this->checkBoxOpenOnStartup->Location = System::Drawing::Point(132, 35);
			...
			this->fileChosen->Location = System::Drawing::Point(160, 32);
			...
			this->label5->Location = System::Drawing::Point(160, 0);
			...
			this->label6->Location = System::Drawing::Point(160, 64);
			...
			this->label7->Location = System::Drawing::Point(160, 90);
			this->label7->Name = L"label7";
			this->label7->Size = System::Drawing::Size(112, 13);
			this->label7->TabIndex = 12;
			this->label7->Text = L"Will rank files by rating";
			this->toolTip1->SetToolTip(this->label7, L"Sorts top and bottom list by rating. Usefull for large image collections where it"
				L" is unreasonable to compare all images");
			// 
